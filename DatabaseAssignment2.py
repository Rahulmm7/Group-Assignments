...
cur.execute(f"SELECT DISTINCT * FROM Employee INNER JOIN Departments where Employee.Department_id='{dep_id}' and Departments.Department_id=Employee.Department_id")
d=cur.fetchall()
for i in d:
